...
echo -e "${BLUE}  Server v1.1.0 (userColor sync support)${NC}"
echo -e "${BLUE}======================================================${NC}"
echo ""
...
cat > package.json << 'EOF'
{
  ...
  "version": "1.1.0",
  "description": "Backend server for Zotero Reading Heatmap plugin (with userColor sync)",
  "main": "server.js",
  "scripts": {
...
echo -e ""
echo -e "${GREEN}======================================================${NC}"
echo -e "${GREEN}  部署完成！Zotero Reading Heatmap Server v1.1.0 正在运行。${NC}"
echo -e "${GREEN}======================================================${NC}"
echo -e ""
